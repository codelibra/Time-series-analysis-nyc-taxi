...
public class WeeklyStlReducer extends Reducer<Text, Text, Text, Text> {
    ...
    public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
		...
		String gridId = key.toString();		
                String aggregatedGridId = dateFormat.format(date) + "_" + gridId;
            ...
            if(dataAvailable < 0.7*totalData)
		return;
	    ...
	    double[] freqData = ArrayUtils.toPrimitive(freqDataList.toArray(new Double[0]));
            ...
            SeasonalTrendLoess smoother = builder.setPeriodLength(7). // Data has a period of 12
