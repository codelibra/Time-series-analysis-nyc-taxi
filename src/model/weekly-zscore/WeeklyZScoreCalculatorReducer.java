...
public class WeeklyZScoreCalculatorReducer extends Reducer<Text, Text, Text, Text> {
 ...
 public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {  
	...
	System.out.println(groupIds.get(i)+" " + modified_z_scores.get(i));
     ...
     for(int i=0;i<modified_z_scores.size();i++)
     {
	  ...
	  {
 	         String output = longitude + "," + latitude + "," + originalFreq.get(i) + "," + residuals.get(i) + "," + modified_z_scores.get(i);
